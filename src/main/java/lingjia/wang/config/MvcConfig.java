...
import lingjia.wang.web.interceptor.InstallInterceptor;
import lingjia.wang.web.interceptor.LoginInterceptor;
...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = "lingjia.wang.web.controller")
