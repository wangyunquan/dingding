...
public interface PostRepository extends JpaRepository<Post,Long>{
     ...
     * @return list
     */
    @Query(value = "SELECT * FROM cms_post where post_type='post' ORDER BY post_date DESC LIMIT 5",nativeQuery = true)
     ...
     * @return List<Object[]></>
     */
    @Query(value = "select year(post_date) as year,month(post_date) as month,count(*) as count from cms_post where post_status=0 and post_type='post' group by year(post_date),month(post_date) order by year desc,month desc",nativeQuery = true)
     ...
     * @return List<Object[]></>
     */
    @Query(value = "select year(post_date) as year,count(*) as count from cms_post where post_status=0 and post_type='post' group by year(post_date) order by year desc",nativeQuery = true)
     ...
     * @return List<Post></>
     */
    @Query(value = "select *,year(post_date) as year,month(post_date) as month from cms_post where post_status=0 and post_type='post' and year(post_date)=:year and month(post_date)=:month order by post_date desc",nativeQuery = true)
     ...
     * @return List<Post></>
     */
    @Query(value = "select *,year(post_date) as year from cms_post where post_status=0 and post_type='post' and year(post_date)=:year order by post_date desc",nativeQuery = true)
     ...
     * @return Page<Post></>
     */
    @Query(value = "select * from cms_post where post_status=0 and post_type='post' and year(post_date)=:year and month(post_date)=:month order by post_date desc",countQuery = "select count(*) from cms_post where post_status=0 and year(post_date)=:year and month(post_date)=:month",nativeQuery = true)
     ...
     * @return Page<Post></>
     */
    @Query(value = "select * from cms_post where post_status = 0 and post_type='post' and post_title like '%=:keyword%' or post_content like '%=:keyword%'",nativeQuery = true)
