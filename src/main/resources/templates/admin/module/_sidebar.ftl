    ...
    <section class="sidebar">
        <div class="user-panel">
            <div class="pull-left image">
                <img src="<#if profile.avatar?if_exists!="">${profile.avatar?if_exists}<#else >/static/images/default.png</#if>" class="img-circle" alt="User Image">
            </div>
            <div class="pull-left info">
                <p>${profile.name?if_exists}</p><a href="/admin/profile"><i class="fa fa-circle text-success"></i>编辑</a>
            </div>
        </div>
